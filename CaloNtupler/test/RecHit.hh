...
float fPt = 0., fEnergy = 0., fRho = 0., fX = 0., fY = 0., fZ = 0., fGenE = 0., fGain = 0., fInPedAvg = 0., fEraw = 0., fIeta = 0., fIphi = 0., fDepth = 0., fEm3 = 0.; 
int fEvent = 0, fPU =0; 
...
int nPU;
std::vector<float> fInPedestal, fRaw, fPed, fInNoiseADC, fInNoisePhoto, fInputTDC;
