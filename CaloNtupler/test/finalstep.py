...
# with command line options: step2 --mc --datatier GEN-SIM-RECO -n 10 --era Run3 --eventcontent RECOSIM -s RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --conditions 106X_mcRun3_2023_realistic_v3
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.recosim_step,process.ntuple_step,process.endjob_step)#,process.RECOSIMoutput_step)
