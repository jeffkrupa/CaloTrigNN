...
CMSSW="CMSSW_11_1_0_pre8"
CMSSW_TGZ="CMSSW_11_1_0_pre8.tgz"
...
export SCRAM_ARCH=slc7_amd64_gcc820 #slc7_amd64_gcc700
...
cmsRun step2.py
rm step1.root
cmsRun ntuple.py #step3_RAW2DIGI_L1Reco_RECO_RECOSIM_PU.py
rm step2.root

fName="Output_${ID}_${RANDOM}.root"
fName3="Output_${ID}_${RANDOM}_step3.root"
...
xrdcp $fName3 root://cmseos.fnal.gov//store/user/jkrupa/hcal_gnn/${ID} #rh_106X_upgrade2021_realistic_v5_RH_ZSgenEgt01_PUFlat55to75Run3OOTPU
